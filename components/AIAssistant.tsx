...
const AIAssistant: React.FC<AIAssistantProps> = ({ isOpen, onClose }) => {
  const [messages, setMessages] = useState<Message[]>([
    { role: 'model', content: "Hello! I'm the ProService USA Diagnostic Assistant. Describe your issue and I'll help you figure out what's wrong." }
  ]);
        ...
        <div className="bg-blue-900 p-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-200 text-xs font-medium uppercase tracking-widest">ProService USA Intelligence</p>
            </div>
          </div>
