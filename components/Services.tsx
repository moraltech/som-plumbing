...
// Defining props for Services component to fix the "onSelectService does not exist" error in App.tsx
        ...
        {serviceList.map((service, index) => (
          ...
          >
            ...
            <button 
              ...
              className="mt-auto text-blue-700 font-bold flex items-center gap-2 hover:gap-4 transition-all"
            >
